...
class INtianjia extends JFrame implements ActionListener{
	 JTextField first,second,third,fouth,fifth,sixth;
	 ...
	 public INtianjia()
	 {
		 ...
		 add(beizhu);
		 beizhu.setBounds(20, 170, 60, 25);
		 bei = new JTextArea();
		 add(bei);
		 bei.setBounds(80, 170, 500, 150);
		 queding = new JButton("确定");
		 add(queding);
		 queding.setBounds(130, 350, 80, 30);
		 quxiao = new JButton("取消");
		 add(quxiao);
		 quxiao.setBounds(390, 350, 80, 30);
		 //注册监听器
		 ...
		 if(e.getSource()==queding)            
		 {
			 ...
			 case JOptionPane.YES_OPTION:
				 ...
				 try {//连接数据库
					 ...
					 String strSQLInsert = "INSERT INTO ruku VALUES ('"+aa+"','"+bb+"','"+cc+"','"+dd+"','"+ee+"','"+ff+"','"+jj+"')";
