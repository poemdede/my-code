...
import javax.swing.*;
class OUTxiugai extends JFrame implements ActionListener{
	 JTextField first,second,third,fouth,fifth,seven;
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==queding)
		{
			...
			try {//连接数据库
				...
				String strSQLUpdate = "UPDATE chuku SET 仓库编号='"+aa+"',货品名称='"+bb+"',出库时间='"+cc+"',重量='"+dd+"',备注='"+ee+"' WHERE 编号='"+gg+"'";
