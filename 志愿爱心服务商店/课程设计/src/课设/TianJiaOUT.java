...
class OUTtianjia extends JFrame implements ActionListener{
	JTextField first,second,third,fouth,fifth;
	JButton queding,quxiao;
	JTextArea bei;
	JLabel bianhao,mingcheng,dizhi,lianxiren,dianhua,chuanzhen,beizhu;
	public OUTtianjia()
	{
		//UI初始化
		setLayout(null);
		...
		if(e.getSource()==queding)            
		{
			...
			case JOptionPane.YES_OPTION:
				...
				try {//连接数据库
					...
					String strSQLInsert = "INSERT INTO chuku VALUES ('"+aa+"','"+bb+"','"+cc+"','"+dd+"','"+ee+"','"+jj+"')";
