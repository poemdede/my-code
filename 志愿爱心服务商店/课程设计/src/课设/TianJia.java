...
class GetAdd extends JFrame implements ActionListener{
		 ...
		 if(e.getSource()==queding)            
		 {
			 ...
			 case JOptionPane.YES_OPTION:
				 ...
				 try {//连接数据库
					 ...
					 String strSQLInsert = "INSERT INTO gongyingshang VALUES ('"+kk+"','"+aa+"','"+bb+"','"+cc+"','"+dd+"','"+ee+"','"+ff+"','"+gg+"','"+hh+"','"+ii
					 +"','"+jj+"')";
